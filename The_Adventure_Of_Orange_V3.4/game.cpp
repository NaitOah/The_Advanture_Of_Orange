        ...
        if (saveConfirmation == 0) {
            ...
            if (gameState->currentFloor == 1) {
                draw_map(gameState->floor1State.map, gameState->player, gameState->floor1State.enemy, gameState->floor1State.enemy2,
                    playerImage, playerWithSwordImage, swordImage, orangeImage, enemyImage, enemy2Image, goldImage, wallImage, doorImage, keyImage, npc1Image, upStairsImage, downStairsImage, true);
                ...
                draw_map(gameState->floor2State.map, gameState->player, gameState->floor2State.enemy, gameState->floor2State.enemy2,
                    playerImage, playerWithSwordImage, swordImage, orangeImage, enemyImage, enemy2Image, goldImage, wallImage, doorImage, keyImage, npc1Image, upStairsImage, downStairsImage, false);
                draw_status_bar(gameState->player, playerImage, playerWithSwordImage, heartImage, goldOrangeImage);
            }
            ...
            if (kbhit()) {
                ...
                switch (command) {
                    case 'w': move_player(&gameState->player, -1, 0, gameState->floor1State, gameState->floor2State, gameState->currentFloor,
                            playerImage, playerWithSwordImage, swordImage, orangeImage, enemyImage, enemy2Image, heartImage, goldImage, wallImage, doorImage, keyImage, npc1Image, upStairsImage, downStairsImage); break;
