...
void draw_map(int map[HEIGHT][WIDTH], Character player, Character enemy1, Character enemy2,
              ...
              PIMAGE keyImage, PIMAGE npc1Image, PIMAGE upStairsImage, PIMAGE downStairsImage, PIMAGE princessImage, bool drawEnemy) {
    setcolor(WHITE);
        ...
        for (int j = 0; j < WIDTH; j++) {
            switch(map[i][j]) {
                ...
                case DOWN_STAIRS:
                    ...
                    break;
                case PRINCESS:
                    putimage_withalpha(NULL, princessImage, j * CELL_SIZE, i * CELL_SIZE);
                    break;
            }
        }
    }
